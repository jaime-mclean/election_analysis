...
highest_county = ""
highest_voter_count = 0
highest_voter_percentage = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_turnout:
        ...
        if (turnout > highest_voter_count) and (turnout_percentage > highest_voter_percentage):

    # 7: Print the county with the largest turnout to the terminal.
            highest_voter_count = turnout

            highest_voter_percentage = turnout_percentage
